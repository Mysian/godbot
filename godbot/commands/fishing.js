...
function hintLine(tension, hpRatio) {
  const H_NEUT = [
    "물속에서 은근한 파동이 전해져 옵니다. 아직은 큰 움직임은 느껴지지 않습니다.",
    "작은 떨림이 전해지지만, 어디로 튈지 알 수 없는 애매한 기류가 이어집니다.",
    "고요 속에 작은 흔들림이 섞여 들어옵니다. 뭔가를 감추고 있는 듯 모호합니다.",
    "은근히 파문이 번지지만, 확실한 방향은 잡히지 않습니다.",
    "잔잔한 움직임 속에 불규칙한 떨림이 스며 있습니다.",
    "잠시 멈춘 듯하다가도 미세한 기척이 스쳐 지나갑니다.",
    "심연 속에서 정체 모를 흐름이 올라옵니다.",
    "물결과 함께 규칙 없는 리듬이 감돌고 있습니다.",
    "작은 흔들림이 이어지지만, 정적에 묻혀 잘 드러나지 않습니다.",
    "낯선 긴장감이 얕게 깔려 있습니다.",
    "조용히 기척이 일렁입니다. 숨은 의도를 알 수 없습니다.",
    "불분명한 떨림이 간헐적으로 다가옵니다.",
    "작은 파문이 끊어졌다 이어집니다.",
    "머뭇거리는 듯한 움직임이 고요를 흔듭니다.",
    "확실치 않은 기류가 흘러 지나갑니다.",
    "호흡하듯 가볍게 일렁입니다.",
    "속을 알 수 없는 흔들림이 이어집니다.",
    "작게 이어지던 떨림이 사라졌다가 다시 스며듭니다.",
    "맑은 물결 속에 미약한 흔들림이 얹혀 있습니다.",
    "얕은 긴장감이 불규칙하게 몰려옵니다.",
    "심연 속에서 작은 울림이 피어오릅니다.",
    "정적 속에 희미한 파동이 가득합니다.",
    "잡히지 않는 미세한 움직임이 이어집니다.",
    "가볍게 꿈틀거림이 번져갑니다.",
    "의도 모를 작은 저항이 숨어 있습니다.",
    "고요 속에도 알 수 없는 긴장이 맴돕니다.",
    "느릿하지만 낯선 떨림이 이어집니다.",
    "규칙 없는 흔들림이 간간이 치고 들어옵니다.",
    "스쳐가는 듯한 미묘한 기류가 감돕니다.",
    "확신하기 힘든 파문이 맴돌고 있습니다."
  ];

  const H_HIGH = [
    "줄이 한껏 팽팽해집니다. 터질 듯 위태로운 긴장감이 손끝을 조입니다.",
    "강한 저항이 몰아치며 줄을 잔뜩 당겨옵니다. 위험한 긴장이 스며듭니다.",
    "무겁게 억눌리는 힘이 전해집니다. 언제 끊어질지 모를 불안이 감돕니다.",
    "팽팽한 긴장감이 물결처럼 퍼집니다. 한순간의 틈조차 없습니다.",
    "사납게 치받는 힘이 이어집니다. 마치 벼랑 끝에 선 듯 아슬아슬합니다.",
    "굳건히 버티는 압박이 이어집니다. 온 신경이 곤두섭니다.",
    "끊어질 듯 날카로운 긴장감이 줄을 타고 손끝으로 번집니다.",
    "강렬한 저항이 끊임없이 이어집니다. 물살조차 휘청이는 듯합니다.",
    "줄이 칼날처럼 날카롭게 팽팽해집니다. 숨조차 막히는 순간입니다.",
    "모든 힘이 끌어당겨지는 듯한 압박감이 감돕니다.",
    "사납게 당겨지는 힘이 온몸을 긴장하게 만듭니다.",
    "끝을 알 수 없는 강도 높은 저항이 계속 이어집니다.",
    "굉음을 내듯 줄이 휘어지고 있습니다.",
    "매섭게 몰아치는 긴장이 손끝을 마비시킵니다.",
    "칼날 위에 선 듯 위태로운 기세가 이어집니다.",
    "무자비하게 버티는 힘이 끊임없이 밀려옵니다.",
    "줄이 마치 끊어질 듯 떨립니다. 팽팽한 기세입니다.",
    "위협적인 긴장감이 가득합니다. 한순간의 방심도 허락하지 않습니다.",
    "버거운 무게가 끊임없이 끌어당기고 있습니다.",
    "질식할 듯 강렬한 압박이 몰려옵니다.",
    "끊임없는 저항이 매섭게 이어집니다.",
    "사납게 당겨지는 줄이 손을 짓누릅니다.",
    "불안이 고조되는 순간이 이어집니다.",
    "팽팽하게 휘어진 줄이 위태롭게 흔들립니다.",
    "극도의 긴장감이 물결과 함께 몰려옵니다.",
    "공포스러운 압박감이 사방에서 스며듭니다.",
    "숨이 막힐 만큼 매섭게 당겨집니다.",
    "휘청거릴 정도로 무겁게 버텨냅니다.",
    "온몸을 옥죄는 듯한 긴장감이 이어집니다.",
    "폭발 직전 같은 위태로움이 손끝을 짓누릅니다."
  ];

  const H_LOW = [
    "줄이 헐겁게 늘어져 있습니다. 묘하게 기세가 빠져 있습니다.",
    "힘이 빠진 듯 줄이 느슨하게 흔들립니다.",
    "잔뜩 조여 있던 긴장이 풀리며, 가벼운 기류만 남아 있습니다.",
    "부드럽게 움직임이 이어지지만 강렬함은 사라졌습니다.",
    "빈틈이 드러난 듯 줄이 가볍게 흔들립니다.",
    "어느새 여유로운 흐름이 스며 있습니다.",
    "묽은 긴장감만이 이어집니다. 무게가 크게 느껴지지 않습니다.",
    "물결과 함께 힘이 빠져나간 듯 잔잔합니다.",
    "기세가 풀리고 가볍게 흔들리는 움직임만 이어집니다.",
    "헐거운 줄이 흔들리며 여유로운 흐름을 만듭니다.",
    "저항의 무게가 줄어들며 공허한 울림만 남습니다.",
    "느슨한 결이 퍼져가며 움직임이 희미해집니다.",
    "차분하게 잔물결만 이어집니다.",
    "큰 힘은 사라지고 가벼운 떨림만 전해집니다.",
    "여유로운 간격으로 기류가 흐릅니다.",
    "한껏 조여 있던 긴장이 흘러내립니다.",
    "미약한 움직임만이 고요 속을 채웁니다.",
    "어쩐지 힘이 빠져나간 듯 잔잔합니다.",
    "거센 저항은 사라지고 가볍게 출렁입니다.",
    "줄이 흔들릴 뿐 강한 압박은 없습니다.",
    "느릿한 움직임만 이어지고 있습니다.",
    "저항이 희미해지고 힘이 공허하게 빠져갑니다.",
    "부드럽게 출렁일 뿐입니다.",
    "대체로 긴장이 풀려 있습니다.",
    "이따금 느슨하게 움직임이 이어집니다.",
    "조용히 힘이 빠져가는 듯합니다.",
  ...
  const H_STRONG = [
    "거센 힘이 줄을 타고 폭풍처럼 몰려옵니다. 마치 바다 전체가 흔들리는 듯합니다.",
    "사납게 흔들리며 줄을 무자비하게 당겨냅니다.",
    "격렬한 저항이 쉼 없이 이어집니다. 굉음처럼 손끝을 때립니다.",
    "맹렬히 저항하며 물결을 뒤흔듭니다.",
    "전방위로 몸부림치며 포효하듯 기세를 뿜어냅니다.",
    "분노에 찬 몸짓이 끊임없이 이어집니다.",
    "휘몰아치는 저항이 물살을 가릅니다.",
    "벼락처럼 몰아치는 움직임이 전해집니다.",
    "끊임없는 저항이 폭풍우처럼 이어집니다.",
    "사납게 몸부림치며 줄을 뒤흔듭니다.",
    "포효하듯 몰아치는 기세가 감돕니다.",
    "불꽃처럼 튀어 오르며 저항합니다.",
    "위협적인 기운이 파도처럼 이어집니다.",
    "맹렬히 흔들리며 제어할 틈을 주지 않습니다.",
    "폭발적인 기세가 끊임없이 이어집니다.",
    "공포스러운 기세로 저항을 이어갑니다.",
    "광폭하게 버둥거리며 움직임을 키워갑니다.",
    "끝없는 힘이 밀려와 줄을 휘게 만듭니다.",
    "짐승 같은 거친 움직임이 몰려듭니다.",
    "전율이 이는 저항이 이어집니다.",
    "격정적인 몸부림이 이어집니다.",
    "사나운 기세가 멈추지 않습니다.",
    "분출하는 힘이 사방으로 튀어오릅니다.",
    "공격적으로 휘몰아치는 파동이 이어집니다.",
    "제어하기 버거운 거친 저항이 이어집니다.",
    "마구 날뛰는 기세가 줄을 무겁게 만듭니다.",
    "불안정하게 솟구치며 위협을 더합니다.",
    "강렬한 파동이 폭발하듯 번져갑니다.",
    "사납게 흔들며 온 주변을 뒤흔듭니다.",
    "쉬지 않고 이어지는 거대한 몸부림입니다."
  ];

  const H_WEAK = [
    "점차 기세가 꺾입니다. 움직임은 느려지고 힘은 희미해집니다.",
    "움찔거림이 줄어들며 무게감도 가볍게 사라져갑니다.",
    "기운이 빠져나간 듯 움직임이 둔해집니다.",
    "더딘 움직임 속에 지친 기색이 번집니다.",
    "점차 무력해지며 저항은 흐릿해집니다.",
    "기세가 약해지고 생기 없는 움직임만 이어집니다.",
    "버거운 듯 둔탁한 몸짓이 이어집니다.",
    "숨이 가빠지는 듯 지쳐갑니다.",
    "한풀 꺾이며 무거운 기세가 사라집니다.",
    "지쳐 쓰러질 듯 힘이 빠져나갑니다.",
    "잔뜩 늘어진 듯 힘이 전해지지 않습니다.",
    "침잠하듯 고요해집니다.",
    "둔한 기세만 이어지고 있습니다.",
    "호흡이 흐려지고 힘이 공허해집니다.",
    "남은 힘을 짜내는 듯 희미한 저항만 이어집니다.",
    "움직임이 매마르고 생동감이 사라집니다.",
    "둔탁한 흐름이 이어질 뿐입니다.",
    ...
    "느릿하게 이어지지만 기세는 없습니다.",
    "힘겨워하며 겨우 움직임을 이어갑니다.",
    "저항은 약해지고 지친 기운만 감돕니다.",
    "마치 빈 껍데기처럼 움직임이 비어 있습니다.",
    "침잠하는 듯 고요 속으로 빠져듭니다.",
    "생기가 끊기며 움직임이 사라집니다.",
    "조용히 꺼져가는 듯합니다.",
    "희미한 떨림만이 남아 있습니다.",
    "기운이 다 빠져 더는 힘을 쓰지 못합니다.",
    "마지막 흔들림이 잦아들고 있습니다."
  ];
  const picks = [];
...
const DROP_TABLE = {
  ...
  "레어":   ["전갱이","고등어","가재","연어","다랑어","가자미","오징어","잉어","삼치","복어","황어","도미","참돔","붕어","비단 잉어","빙어","갈치","파랑 정수","큰입배스","참다랑어","황다랑어",
             "꼴뚜기"],
  "유니크": ["참치","장어","개복치","문어","거북이","까리한 열쇠","까리한 보물상자","메기","블롭피쉬","그림자 장어","별빛 잉어","심연의 복어","황금 잉어"],
  "레전드": ["곰치","고래상어","빨판상어","청새치","아귀","에테르 피쉬","덤보 문어","샤이닝 해파리"],
