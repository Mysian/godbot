...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const row1 = new ActionRowBuilder().addComponents(
      new ButtonBuilder()
        .setCustomId("status_msg")
        .setLabel("상태 메시지 등록")
        .setStyle(ButtonStyle.Primary),
      new ButtonBuilder()
        .setCustomId("favorite_games")
        .setLabel("선호 게임 등록")
        .setStyle(ButtonStyle.Primary),
      new ButtonBuilder()
        .setCustomId("ow_tier")
