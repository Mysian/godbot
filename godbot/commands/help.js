    ...
    embeds.push(
      new EmbedBuilder()
        ...
        .addFields(
          ...
          { name: "🛑 /챔피언배틀종료", value: "진행 중인 배틀 중 하나만 선택해서 강제 종료합니다.", inline: true },
    ...
    embeds.push(
      new EmbedBuilder()
        ...
        .addFields(
          ...
          { name: "🗑️ /롤티어초기화", value: "내 롤 티어 정보를 초기화합니다.", inline: true },
          ...
          { name: "🗑️ /옵치티어초기화", value: "오버워치 티어 정보를 초기화합니다.", inline: true },
