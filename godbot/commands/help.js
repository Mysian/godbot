...
embeds.push(
  new EmbedBuilder()
    ...
    .setDescription([
      ...
      "",
      "### 💎 구독(정기 후원) 안내",
      "**패트리온 구독을 통해 매달 자동 후원도 가능합니다!**",
      " • 구독자는 경험치 부스터 +333, 프리미엄 역할, 각종 이벤트 우선권 등 특별 혜택 제공",
      " • 구독은 언제든 해지 가능하며, `/구독` 명령어로 자세한 안내와 구독 신청 링크 확인 가능",
      "",
      "> **💡 정기 구독은 [패트리온 페이지](https://www.patreon.com/kkari)에서 신청할 수 있습니다!**"
    ].join('\n'))
    .setFooter({ text: "서버: 까리한 디스코드" })
    .setColor(0xFF69B4)
    .setTimestamp()
