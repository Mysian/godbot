...
module.exports = {
  ...
  "투명와드": {
    ...
    effect: (user, context) => {
      ...
      context.effects[enemyId].push({ type: "dodgeDown", value: 0.01, turns: 1 });
  ...
  "마법의영약": {
    ...
    effect: (user, context) => {
      ...
      context.effects[user.id].push({ type: "apBuff", value: user.stats.ap * 0.05, turns: 3, from: "마법의영약" });
  ...
  "분노의영약": {
    ...
    effect: (user, context) => {
      ...
      context.effects[user.id].push({ type: "atkBuff", value: user.stats.attack * 0.05, turns: 3, from: "분노의영약" });
  ...
  "강철의영약": {
    ...
    effect: (user, context) => {
      ...
      context.effects[user.id].push({ type: "maxHpBuff", value: user.stats.hp * 0.05, turns: 3, from: "강철의영약" });
  ...
  "도란의검": {
    ...
    effect: (user, context) => {
      ...
      context.effects[user.id].push({ type: "lifesteal", value: 0.05, turns: 3, from: "도란의검" });
  ...
  "도란의방패": {
    ...
    effect: (user, context) => {
      ...
      context.effects[user.id].push({ type: "damageReduce", value: 0.02, turns: 3, from: "도란의방패" });
  ...
  "천갑옷": {
    ...
    effect: (user, context) => {
      ...
      context.effects[user.id].push({ type: "defBuff", value: user.stats.defense * 0.02, turns: 1, from: "천갑옷" });
  ...
  "민첩성의망토": {
    ...
    effect: (user, context) => {
      ...
      context.effects[user.id].push({ type: "critUp", value: 0.02, turns: 3, from: "민첩성의망토" });
