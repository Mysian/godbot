...
"오늘의 작은 한 걸음이 내일의 큰 도약이 될 수 있습니다.",
"실패에 좌절하지 말고 다시 일어서는 용기를 가져보세요.",
"천천히 가더라도 포기하지 않고 계속 앞으로 나아가세요.",
"노력은 결코 배신하지 않는다는 사실을 기억하세요.",
"지금의 어려움도 언젠가는 소중한 추억이 될 거예요.",
"포기라는 단어 대신 도전이라는 단어를 선택해보세요.",
"매일 조금씩 성장하는 나 자신을 칭찬해 주세요.",
"작은 실천이 모여 결국 큰 변화를 만들어냅니다.",
"꿈을 향한 꾸준한 노력이 반드시 빛을 발할 거예요.",
"오늘 하루도 최선을 다한 나를 응원해 주세요.",
"실패는 성공으로 가는 과정임을 잊지 마세요.",
"어려운 시기일수록 더욱 단단해질 수 있습니다.",
"끝까지 해내는 의지가 진정한 실력입니다.",
"남들과 비교하지 말고 어제의 나와 경쟁하세요.",
"지금 이 순간도 인생에서 가장 소중한 시간입니다.",
"행복은 멀리 있는 것이 아니라 내 곁에 있습니다.",
"긍정적인 생각이 좋은 결과를 만들어냅니다.",
"꿈꾸는 자만이 결국 꿈을 이룰 수 있습니다.",
"노력하는 만큼 결과는 반드시 따라온다고 믿으세요.",
"힘들 때일수록 잠시 쉬어가도 괜찮아요.",
"실패도 결국엔 더 나은 나를 위한 경험입니다.",
"성공은 빠르게 오는 것이 아니라, 멈추지 않는 데 있습니다.",
"오늘의 선택이 내일의 나를 만들어줍니다.",
"항상 감사하는 마음으로 하루를 시작해보세요.",
"작은 친절이 누군가의 인생을 바꿀 수 있습니다.",
"내가 걷는 길이 남들과 달라도 괜찮아요.",
"끝이라고 생각하는 곳이 새로운 시작일 수 있습니다.",
"매일 반복되는 일상 속에도 작은 기쁨이 있습니다.",
"스스로를 믿는 마음이 가장 큰 힘이 됩니다.",
"누군가의 따뜻한 말 한마디가 큰 힘이 됩니다.",
"한 번 더 도전하는 용기가 변화를 만듭니다.",
"고민이 많을수록 그만큼 성장할 수 있습니다.",
"실수는 더 나은 나로 성장하는 밑거름입니다.",
"내일은 오늘보다 더 나은 내가 되길 바랍니다.",
"사소한 습관 하나가 인생을 바꿀 수도 있습니다.",
"힘들 땐 하늘을 보며 잠시 쉬어가도 괜찮아요.",
"노력은 결과를 배신하지 않는다는 걸 기억하세요.",
"작은 목표부터 하나씩 이뤄나가는 기쁨을 느껴보세요.",
"포기하지 않고 달리면 결국 도착점에 도달하게 됩니다.",
"내가 바라는 삶을 위해 오늘도 최선을 다해보세요.",
"지금 이 순간이 인생의 전환점이 될 수 있습니다.",
"실패를 두려워하지 않고 계속 도전해보세요.",
"작은 성공을 축하하는 습관을 가져보세요.",
"힘든 시기에도 웃을 수 있는 자신을 응원합니다.",
"새로운 시작을 두려워하지 말고 도전해보세요.",
"누구나 처음에는 서툴지만 반복이 실력을 만듭니다.",
"불가능해 보여도 도전하면 가능해질 수 있습니다.",
"오늘의 노력이 내일의 자신감을 만들어줍니다.",
"당신의 노력이 언젠가 반드시 빛을 발할 거예요.",
];
const ENGLISH = [
...
"Don’t let yesterday take up too much of today’s energy.",
"The best way to predict the future is to create it yourself.",
"Push yourself, because no one else is going to do it for you.",
"Success doesn’t come from what you do occasionally, but daily.",
"You are never too old to set another goal or dream a new dream.",
"Every day is a new beginning. Take a deep breath and start.",
"Perseverance is not a long race; it’s many short ones together.",
"Don’t dream about success. Work hard for it every single day.",
"The only real mistake is the one from which we learn nothing.",
...
"If opportunity doesn’t knock, build a door and open it yourself.",
"Life is short. Focus on what matters and let go of the rest.",
"The road to success is always under construction. Keep building.",
"You miss 100% of the shots you don’t take, so take a chance.",
"Don’t limit your challenges. Challenge your own limits every day.",
"Stars can’t shine without darkness. Embrace tough times too.",
"Just keep moving forward and don’t worry about others’ opinions.",
"Dreams don’t work unless you do, so keep chasing your goals.",
"Small steps every day will lead to big results in your life.",
"Wake up with determination. Go to bed with satisfaction.",
"The difference between ordinary and extraordinary is that little extra.",
"Act as if what you do makes a difference. Because it does.",
"Believe you can and you’re already halfway there to your goal.",
"Don’t be pushed around by the fears in your own mind.",
"Turn your wounds into wisdom and learn from every mistake.",
"The expert in anything was once just a beginner like you.",
"Keep your eyes on the stars, and your feet on the ground.",
"It always seems impossible until it’s finally done by someone.",
"Your dreams don’t have an expiration date. Start now.",
"Be so good they can’t ignore you, no matter what you do.",
